...
namespace Podcaster.Controllers
{
    public class PodcastsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,PodcastTitle,PodcastRss,PodcastImage,Category")] Podcast podcast)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,PodcastTitle,PodcastRss,PodcastImage,Category")] Podcast podcast)
        {
            if (ModelState.IsValid)
            {
